...
Int1LeftShift:
    ...
    bne $s0, $zero, Int1LeftShift
    sub $s4,$s4,$s5      #循环次数递减
    bne $s4, $zero, Int1Loop
...
Int2LeftShift:
    ...
    bne $s0, $zero, Int2LeftShift
    sub $s4,$s4,$s5      #循环次数递减
    bne $s4, $zero, Int2Loop
...
Int3LeftShift:
    ...
    bne $s0, $zero, Int3LeftShift
    sub $s4,$s4,$s5      #循环次数递减
    bne $s4, $zero, Int3Loop
